    ...
    public partial class ScreenCaptureCode
    {
        public static async Task CaptureImageToFile()
        {
            try
            {
                ...
                ImageFormats ScreenshotSaveFormat = (ImageFormats)SettingLoad(vConfigurationTool, "ScreenshotSaveFormat", typeof(int));
                int ScreenshotSaveQuality = SettingLoad(vConfigurationTool, "ScreenshotSaveQuality", typeof(int));
